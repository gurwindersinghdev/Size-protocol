...
library LoanLibrary {
        ...
        returns (uint256)
    {
        ...
        if (debt != 0) {
            return Math.mulDivDown(collateral, debtPosition.futureValue, debt);       // x * y / z
        } else {
            return 0;
        }
    }
        ...
        returns (uint256)
    {
        ...
        if (debtPositionFutureValue != 0) {
            return Math.mulDivDown(debtPositionCollateral, creditPositionCredit, debtPositionFutureValue);        // x * y / d
        } else {
            return 0;
        }
    }
